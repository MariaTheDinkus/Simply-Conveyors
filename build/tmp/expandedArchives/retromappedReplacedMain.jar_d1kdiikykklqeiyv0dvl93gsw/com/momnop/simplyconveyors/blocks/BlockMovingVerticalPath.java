...
public class BlockMovingVerticalPath extends BlockHorizontal {
	...
	@Override
	public void func_180634_a(World world, BlockPos pos, IBlockState blockState,
			Entity entity) {
		...
		if (!entity.func_70093_af() && !world.func_175640_z(pos)) {
			...
			entity.field_70181_x += this.getSpeed();
			if (entity.field_70181_x > this.getSpeed()) {
				entity.field_70181_x = this.getSpeed();
			}
			
			if (direction == EnumFacing.EAST) {
				entity.field_70159_w = this.getSpeed();
			}
			...
			if (direction == EnumFacing.SOUTH) {
				entity.field_70179_y = this.getSpeed();
			}
