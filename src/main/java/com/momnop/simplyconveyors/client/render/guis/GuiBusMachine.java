...
public class GuiBusMachine extends GuiScreen
{
    ...
    public void drawScreen(int x, int y, float ticks) {
    	ArrayList<String> strings = (ArrayList<String>) BusStopManager.busStopsNames.clone();
    	Collections.sort(strings);
    	GL11.glEnable(GL11.GL_BLEND);
    	drawDefaultBackground();
    	GL11.glDisable(GL11.GL_BLEND);
    	
    	mc.renderEngine.bindTexture(new ResourceLocation(ModInfo.MODID + ":" + "textures/gui/busMachine.png"));
    	...
    	//GL11.glScaled(mc.displayWidth / 1920, mc.displayWidth / 1920, mc.displayWidth / 1920);
    	...
    	for (String name : strings) {
    		...
    		if (mc.gameSettings.guiScale != 0) {
    			fontRendererObj.drawStringWithShadow(name, ((((mc.gameSettings.guiScale * 0.5F) * width) - guiWidth) / 2) - 300 + (200 * j), ((((mc.gameSettings.guiScale * 0.5F) * height) / 2) - (15 / 2)) - 120 + (i * 13), 0xFFFFFF);
    		} else {
