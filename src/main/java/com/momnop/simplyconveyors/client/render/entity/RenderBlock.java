...
public class RenderBlock extends Render<EntityBlock>
{
	...
	public void doRender(EntityBlock entity, double x, double y, double z, float entityYaw, float partialTicks)
	{
		if(entity.getBlock() != null)
		{
			...
			if(iblockstate != entity.getWorldObj().getBlockState(new BlockPos(entity)) && iblockstate.getRenderType() != EnumBlockRenderType.INVISIBLE
					&& (iblockstate.getBlock() instanceof BlockChest))
			{
			...
			if(iblockstate != entity.getWorldObj().getBlockState(new BlockPos(entity)) && iblockstate.getRenderType() != EnumBlockRenderType.INVISIBLE
					&& (iblockstate.getBlock() instanceof BlockEnderChest))
			{
