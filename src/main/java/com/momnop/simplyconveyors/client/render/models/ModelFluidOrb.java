...
package com.momnop.simplyconveyors.client.render.models;
...
public final class ModelFluidOrb implements IModel, IModelCustomData, IRetexturableModel
{
    public static final ModelResourceLocation LOCATION = new ModelResourceLocation(new ResourceLocation("simplyconveyors", "dynfluidorb"), "inventory");
    ...
    public static final IModel MODEL = new ModelFluidOrb();
    ...
    public ModelFluidOrb()
    {
        this(null, null, null, false);
    }

    public ModelFluidOrb(ResourceLocation baseLocation, ResourceLocation liquidLocation, Fluid fluid, boolean flipGas)
    {
     ...
     */
    @Override
    public ModelFluidOrb process(ImmutableMap<String, String> customData)
    {
        ...
        return new ModelFluidOrb(baseLocation, liquidLocation, fluid, flip);
    }
     ...
     */
    @Override
    public ModelFluidOrb retexture(ImmutableMap<String, String> textures)
    {
        ...
        return new ModelFluidOrb(base, liquid, fluid, flipGas);
    }
    ...
    public enum LoaderDynBucket implements ICustomModelLoader
    {
        ...
        {
            return modelLocation.getResourceDomain().equals("simplyconveyors") && modelLocation.getResourcePath().contains("dynfluidorb");
        }
    ...
    private static final class BakedDynBucket implements IPerspectiveAwareModel
    {
        ...
        private final ModelFluidOrb parent;
        // FIXME: guava cache?
        ...
        public BakedDynBucket(ModelFluidOrb parent,
