...
public class BlockMovingSlowStairPath extends BlockPoweredConveyor implements ITileEntityProvider
{
	...
	public void addCollisionBoxToList(IBlockState state, World worldIn, BlockPos pos, AxisAlignedBB mask, List<AxisAlignedBB> list, Entity entityIn)
	{
		...
		{
			addCollisionBox(new AxisAlignedBB(pos.getX() + 0F, pos.getY() + 0F, pos.getZ() + 0F, pos.getX() + (15.9F / 16F), pos.getY() + 0.5F, pos.getZ() + 1F), list, mask);
		...
		{
			addCollisionBox(new AxisAlignedBB(pos.getX() + 0F, pos.getY() + 0F, pos.getZ() + 0F, pos.getX() + 1F, pos.getY() + 0.5F, pos.getZ() + (15.9F / 16F)), list, mask);
		...
		{
			addCollisionBox(new AxisAlignedBB(pos.getX() + (0.1F / 16F), pos.getY() + 0F, pos.getZ() + 0F, pos.getX() + 1F, pos.getY() + 0.5F, pos.getZ() + 1F), list, mask);
		...
		{
			addCollisionBox(new AxisAlignedBB(pos.getX() + 0F, pos.getY() + 0F, pos.getZ() + (0.1F / 16F), pos.getX() + 1F, pos.getY() + 0.5F, pos.getZ() + 1F), list, mask);
