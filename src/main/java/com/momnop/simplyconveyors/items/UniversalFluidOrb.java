...
public class UniversalFluidOrb extends Item implements IFluidContainerItem
{
    ...
    {
        this(Fluid.BUCKET_VOLUME, new ItemStack(SimplyConveyorsItems.emptyFluidOrb), "fluidOrb", false);
    }
     ...
     */
    public UniversalFluidOrb(int capacity, ItemStack empty, String unlocalizedName, boolean nbtSensitive)
    {
    ...
    public static ItemStack getFilledBucket(UniversalFluidOrb item, Fluid fluid)
    {
